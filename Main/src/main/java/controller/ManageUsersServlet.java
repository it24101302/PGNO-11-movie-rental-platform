...
public class ManageUsersServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Forward to user-stack.jsp
            System.out.println("ManageUsersServlet: Forwarding to user-stack.jsp");
            request.getRequestDispatcher("user-stack.jsp").forward(request, response);
        } catch (Exception e) {
            // Log the error
