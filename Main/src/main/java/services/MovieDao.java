...
public class MovieDao {
    ...
    private static final String filePath = "C:\\Users\\USER\\Downloads\\jacka\\movie_rental_and_review_platform_05\\data\\movies.txt";

    static {
        // Create data directory if it doesn't exist
        File dataDir = new File("C:\\Users\\USER\\Downloads\\jacka\\movie_rental_and_review_platform_05\\data");
        if (!dataDir.exists()) {
            dataDir.mkdirs();
        }
